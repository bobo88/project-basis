...
export default {
  ...
  methods: {
    initChart() {
      // 新增 / 较活跃 / 留存 / 召回 / 忠实
      const colorArr = ['#0bdbdd', '#206bff', '#7386ff', '#cf9eff', '#eec375']
      ...
      setTimeout(() => {
          ...
          if (xAxisInfo) {
            ...
            this.chart.setOption({
              series: {
                ...
                //     if (obj.data[0] === '新增用户') {
                //       key = 0
                //     } else if (obj.data[0] === '较活跃用户') {
                //       key = 1
                //     } else if (obj.data[0] === '留存用户') {
                //       key = 2
                //     } else if (obj.data[0] === '召回用户') {
                //       key = 3
                //     } else if (obj.data[0] === '忠实用户') {
                //       key = 4
                //     }
                //     // console.log(124, obj)
                //     return colorArr[key]
        ...
        _series = _legendArr.map(item => {
          ...
          return {
            ...
            data: filterArr.map(i => {
              ...
              // if (i.indexDim === '新增用户') {
              //   key = 0
              // } else if (i.indexDim === '较活跃用户') {
              //   key = 1
              // } else if (i.indexDim === '留存用户') {
              //   key = 2
              // } else if (i.indexDim === '召回用户') {
              //   key = 3
              // } else if (i.indexDim === '忠实用户') {
              //   key = 4
              // }
              return {
                name: i.name,
        ...
        this.chart.setOption(optionsChart)
      })
      // set
      optionsChart && this.chart.setOption(optionsChart)
    }
  }
}
</script>
