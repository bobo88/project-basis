import SearchOld from '@/components/common/searchOld'
import CompareOld from '@/components/common/compareOld'
import {
  commonConfigChannel,
  commonConfigCountry,
  commonConfigVersion
...
export default {
    ...
    dataSearch: {
      handler(val) {
        this.dataOptions = Object.assign({}, {
          ...
          channel: this.dataSearch.channel || 'ALL',
          clientVersionCode: this.dataSearch.clientVersionCode || 'ALL',
          country: this.dataSearch.country || 'ALL',
          ...
          platform: this.dataSearch.platform || 'ALL',
  ...
  methods: {
    cbSearch(options) {
      console.log(5888, options, this.dataSearch.dimCompare)
