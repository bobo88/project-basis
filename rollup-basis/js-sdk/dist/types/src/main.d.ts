...
export { SDK_CONFIG, CARD_INFO, SOFT_SDK_CONFIG, NSUInteger, extraData, GameEventToOutSide, bounceFun, judgeDeviceType, };
export declare const CLOUD_GAME_SDK: CloudGameSdk;
